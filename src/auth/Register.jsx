      ...
      <div className="relative group w-[90%] max-w-sm p-8 mt-10 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-[0_0_60px_#6526B770] overflow-hidden">
        ...
        <div className="relative  z-20">
          ...
          <div className="mb-6">
            ...
            />
            {errors.fullName && <span className="text-[#6526B7] text-sm mt-1">{errors.fullName.message}</span>}
          </div>
          <div className="mb-6">
          ...
          {/* Login Button */}
          <Button className="w-full py-2 mt-5 text-white bg-[#6526B7] hover:bg-[#5522a1] rounded-lg font-medium transition">
            LOGIN
          </Button>
        </div>
      </div>
